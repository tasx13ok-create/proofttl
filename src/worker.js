...
export default {
  async fetch(request, env, ctx) {
    ...
    if (isFoundryPath(pathname)) return applyAuthCors(await handleFoundry(request, env, pathname), request, env);
