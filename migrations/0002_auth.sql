-- Generated by Better Auth 1.6.25 from scripts/auth-schema-config.js.
-- Core account/session tables + TOTP/recovery-code + passkey plugin schema.
-- Do not hand-edit independently of the schema generator; regenerate and review
-- when Better Auth or the configured plugin set changes.
